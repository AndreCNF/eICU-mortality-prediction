...
# + {"execution": {"iopub.execute_input": "2020-03-06T02:40:18.428128Z", "iopub.status.busy": "2020-03-06T02:40:18.427780Z", "iopub.status.idle": "2020-03-06T02:40:18.437422Z", "shell.execute_reply": "2020-03-06T02:40:18.436390Z", "shell.execute_reply.started": "2020-03-06T02:40:18.428078Z"}, "Collapsed": "false"}
...
# + {"Collapsed": "false", "execution": {"iopub.execute_input": "2020-03-09T16:37:35.157526Z", "iopub.status.busy": "2020-03-09T16:37:35.157248Z", "iopub.status.idle": "2020-03-09T16:37:35.164656Z", "shell.execute_reply": "2020-03-09T16:37:35.163771Z", "shell.execute_reply.started": "2020-03-09T16:37:35.157493Z"}, "persistent_id": "26eac7f3-9081-4a96-ae4a-40054c223fd7"}
for orig_col in cat_feat:
    cat_feat_ohe[orig_col] = [ohe_col for ohe_col in new_columns
                              if ohe_col.startswith(orig_col)]

# + {"Collapsed": "false", "execution": {"iopub.execute_input": "2020-03-09T16:37:35.166280Z", "iopub.status.busy": "2020-03-09T16:37:35.165864Z", "iopub.status.idle": "2020-03-09T16:37:35.190294Z", "shell.execute_reply": "2020-03-09T16:37:35.189358Z", "shell.execute_reply.started": "2020-03-09T16:37:35.166256Z"}}
cat_feat_ohe
...
# + {"Collapsed": "false", "execution_event_id": "fbfc56d3-0060-43b5-937a-c2721d8112d6", "last_executed_text": "stream = open('cat_feat_ohe_patient.yaml', 'w')\nyaml.dump(cat_feat_ohe, stream, default_flow_style=False)", "persistent_id": "57ad30f0-8e12-482d-91c7-789b3b64b39a"}
...
# + {"Collapsed": "false", "execution_event_id": "8163b10f-aedd-470d-957a-48b09166f67a", "last_executed_text": "tmp_col = patient_df.apply(lambda df: df['hospitaldischargeoffset']\n                                      if df['hospitaldischargestatus'] == 'Expired'\n                                      else np.nan, axis=1)\ntmp_col", "persistent_id": "4b2d9b49-c1d2-4e64-81f1-b849ed305d7b"}
tmp_col = patient_df.apply(lambda df: df['hospitaldischargeoffset']
                                      if df['hospitaldischargestatus'] == 'Expired'
                                      else np.nan, axis=1)
tmp_col

# + {"Collapsed": "false", "execution_event_id": "ba7b5c20-008b-43e4-9bcb-d7ecde88913b", "last_executed_text": "tmp_col.index.value_counts()", "persistent_id": "77e65a7d-36b7-410e-80df-7bf1806bfcff"}
tmp_col.index.value_counts()

# + {"Collapsed": "false", "execution_event_id": "d0da93ad-2b2b-4411-9b29-3c7770789598", "last_executed_text": "tmp_col[0][100783]", "persistent_id": "7f64c658-2a41-4ac9-b4f9-9eafd33900a7"}
tmp_col[0][100783]

# + {"Collapsed": "false", "execution_event_id": "6b47f3e4-6e06-4dd7-8fae-f6ef614faa0e", "last_executed_text": "(~tmp_col.isnull()).sum()", "persistent_id": "f87e7659-f89f-4353-a695-4dc670caca8d"}
(~tmp_col.isnull()).sum()

# + {"Collapsed": "false", "execution_event_id": "4a2b0eab-cefe-45df-b91c-f4bfd847aab1", "last_executed_text": "len(patient_df)", "persistent_id": "d7bd0176-c263-4125-b37b-5d16dba60f20"}
len(patient_df)

# + {"Collapsed": "false", "execution_event_id": "2e48aee1-afdd-4995-a967-47f9185e9f86", "last_executed_text": "# Remove duplicate NaNs\ntmp_col = tmp_col.loc[~tmp_col.index.duplicated(keep='first')]", "persistent_id": "12b67de9-406a-4a27-a75b-65264c4c5731"}
# Remove duplicate NaNs
tmp_col = tmp_col.loc[~tmp_col.index.duplicated(keep='first')]

# + {"Collapsed": "false", "execution_event_id": "c3d2f0ee-44ce-47b4-be6c-2e962b34f961", "last_executed_text": "tmp_col.index.value_counts()", "persistent_id": "77e65a7d-36b7-410e-80df-7bf1806bfcff"}
tmp_col.index.value_counts()

# + {"Collapsed": "false", "execution_event_id": "1a0554c9-3ea0-45ed-a79f-bfe4570e9a29", "last_executed_text": "tmp_col[0][100783]", "persistent_id": "7f64c658-2a41-4ac9-b4f9-9eafd33900a7"}
tmp_col[0][100783]

# + {"Collapsed": "false", "execution_event_id": "a5717b19-698e-4722-ba48-783e9101c6be", "last_executed_text": "(~tmp_col.isnull()).sum()", "persistent_id": "f87e7659-f89f-4353-a695-4dc670caca8d"}
(~tmp_col.isnull()).sum()

# + {"Collapsed": "false", "execution_event_id": "b44094c5-5953-47e8-bc04-5e8ab4a6e914", "last_executed_text": "len(patient_df)", "persistent_id": "d7bd0176-c263-4125-b37b-5d16dba60f20"}
len(patient_df)
...
# + {"Collapsed": "false", "execution_event_id": "306946d8-9fb1-46c8-8e76-d5a09e288a3b", "last_executed_text": "# Index setting is failing on modin, so we're just going to skip this part for now\n# patient_df = patient_df.set_index('ts')\n# patient_df.head()", "persistent_id": "a03573d9-f345-4ff4-84b9-2b2a3f73ce27"}
