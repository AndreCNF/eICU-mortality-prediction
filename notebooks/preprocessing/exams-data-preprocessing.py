...
list(set(lab_df_norm.columns) - set(cat_feat) - set(['patientunitstayid', 'ts']))
...
lab_df_norm = du.embedding.join_repeated_rows(lab_df_norm, inplace=True)
lab_df_norm.head()
...
lab_df_norm.to_csv(f'{data_path}cleaned/normalized/ohe/lab.csv')
